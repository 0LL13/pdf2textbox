...
from pdf2textbox import _get_pdf_file
from pdf2textbox import _get_textbox
from pdf2textbox import _extract_textboxes
...
def test_url(url):
    ...
    if textbox[36]['right_column'][0] == " 'des  Personalabbaus  eingeholt  werden.  Das  ist  Ihr \\nProblem. \\n'>>":
        print('Good')
    else:
        print(textbox[36]['right_column'][0])
